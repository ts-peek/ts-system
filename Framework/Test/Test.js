...
Object.prototype.hashCode = function () {
    ...
    this._hashCode = new System.HashCodeBuilder().appendNumber(Math.random(), 10).getHashCode();
    return this._hashCode;
};
...
String.prototype.hashCode = function () {
    ...
    this._hashCode = new System.HashCodeBuilder().appendString(this.value()).getHashCode();
    return this._hashCode;
};
...
Number.prototype.hashCode = function () {
    return new System.HashCodeBuilder().appendNumber(this.value()).getHashCode();
};
...
Boolean.prototype.hashCode = function () {
    return new System.HashCodeBuilder().appendBoolean(this.value()).getHashCode();
};
...
(function (System) {
    ...
    var ObjectUtil = (function () {
        ...
        ObjectUtil.createObject = function (prototype) {
            Contract.isDefined(prototype, System.ExceptionUtil.notDefinedMessage("prototype"));
        ...
        ObjectUtil.implements = function (obj, interfaceName) {
            obj = obj;
            return ObjectUtil.isDefined(obj) && ObjectUtil.isDefined(obj.implements) && obj.implements().indexOf(interfaceName) >= 0;
        };
        ObjectUtil.isArray = function (value) {
            return ObjectUtil.isDefined(Array.isArray) ? Array.isArray(value) : typeof value === "object" && Object.prototype.toString.call(value) === "[object Array]";
        };
...
(function (System) {
    ...
    var NumberUtil = (function () {
        ...
        NumberUtil.isParsableAsNumber = function (value) {
            return System.ObjectUtil.isNumber(parseInt(value, NumberUtil.base10));
        };
    ...
    var StringUtil = (function () {
        ...
        StringUtil.format = function (format) {
            ...
            return format.replace(/{(\d+)}/g, function (match, index) {
                Contract.requires(System.NumberUtil.isParsableAsNumber(index), System.FormatException, "Illegal format item given '" + index + "'");
                var numIndex = parseInt(index, System.NumberUtil.base10);
...
(function (System) {
    ...
    var EqualsBuilder = (function () {
        ...
        EqualsBuilder.prototype.appendString = function (first, second, strategy) {
            if (strategy === void 0) { strategy = 0 /* ORDINAL */; }
            if (!this.equal) {
                return this;
            }
        ...
        EqualsBuilder.prototype.appendStringRelaxed = function (first, second, strategy) {
            ...
            this.equal = strategy === 1 /* IGNORE_CASE */ ? first.toUpperCase() === second.toUpperCase() : first === second;
            return this;
        };
...
(function (System) {
    ...
    var HashCodeBuilder = (function () {
        ...
        HashCodeBuilder.prototype.appendString = function (value, strategy) {
            ...
            value = strategy === 1 /* IGNORE_CASE */ ? value.toUpperCase() : value;
